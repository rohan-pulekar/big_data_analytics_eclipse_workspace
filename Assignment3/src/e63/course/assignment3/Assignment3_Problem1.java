...
public class Assignment3_Problem1 {
	...
	public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
		...
		// defines stopwords to be excluded from final output
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length < 2) {
			System.err.println("Usage: Assignment3_Problem1 <in> [<in>...] <out>");
			System.exit(2);
		}
		Job job = Job.getInstance(conf, "Assignment3_Problem1");
		job.setJarByClass(Assignment3_Problem1.class);
